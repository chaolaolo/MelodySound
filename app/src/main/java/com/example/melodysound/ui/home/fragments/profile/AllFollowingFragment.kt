...
import com.example.melodysound.databinding.FragmentAllFollowingBinding
...
class AllFollowingFragment : Fragment() {
    ...
    private var _binding: FragmentAllFollowingBinding? = null
    ...
    private lateinit var allFollowingAdapter: AllFollowingAdapter
    ...
    override fun onCreateView(
        ...
        _binding = FragmentAllFollowingBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        allFollowingAdapter = AllFollowingAdapter(
            onItemClick = { artist ->
        ...
        binding.rcAllFollowing.apply {
            layoutManager = GridLayoutManager(requireContext(), 3)
            adapter = allFollowingAdapter
        }
                ...
                launch {
                    viewModel.followingArtists.collect { followingArtists ->
                        followingArtists?.let {
                            allFollowingAdapter.submitList(it.artists.items)
                        }
                    }
                }
